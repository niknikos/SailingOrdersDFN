...
fisheries_SO.text <- paste(eval(str2expression(ANNEX_SO$`1.3.9 Biological sampling for fisheries resources`)), collapse = "\n\n")
...
othertrawl_SO.text <- paste(eval(str2expression(ANNEX_SO$`1.3.9.3 Other trawl-related sampling`)), collapse = "\n\n")
...
taxonomy_SO.text <- paste(eval(str2expression(ANNEX_SO$`1.3.9.3.1 Fish and macroinvertebrates samples for regional taxonomy course and post-survey taxonomic studies`)), collapse = "\n\n")
...
cartilaginous_SO.text <- paste(eval(str2expression(ANNEX_SO$`1.3.9.3.2 Cartilaginous fish`)), collapse = "\n\n")
...
foodsafety_SO.text <- paste(eval(str2expression(ANNEX_SO$`1.3.9.3.3 Samples for food safety studies and nutrition`)), collapse = "\n\n")
...
debris_SO.text <- paste(eval(str2expression(ANNEX_SO$`1.3.9.3.4 Marine debris`)), collapse = "\n\n")
...
epibenthos_SO.text <- paste(eval(str2expression(ANNEX_SO$`1.3.9.3.5 Epibenthos`)), collapse = "\n\n")
...
demestimates_SO.text <- paste(eval(str2expression(ANNEX_SO$`1.3.9.4 Demersal fish biomass estimated based on the swept area method`)), collapse = "\n\n")
