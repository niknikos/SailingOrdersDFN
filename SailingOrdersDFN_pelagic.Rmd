...
The collected data will be used to prepare a survey report, and various scientific reports/papers as part of the EAF-Nansen Science Plan, as well as provide input to the regional fisheries resource assessment work (Benguela Current Convention (BCC): <https://www.benguelacc.org/>).
...
-   **Acoustic sampling**:
    ...
    -   Provision of acoustic backscatter estimates (as a proxy for biomass) for the following acoustics groups: sardine ("Pilchard"), anchovy, round herring ("Redeye"), horse mackerel, lanternfish, lightfish and jellyfish.
...
-   **Fish biological sampling**:
    ...
    -   Collection of chub mackerel for registration of meristic information for stock/species identification.
...
-   **Other trawl-related sampling**:
    ...
    -   Size and weight measurements of *Chrysaora fulgida*.
...
Acoustic backscatter data at all available frequencies (18, 38, 70, 120, 200 and 333 kHz) from the Simrad EK80 echo sounder operating in **CW (narrow band)** mode is to be collected continuously while the ship is steaming along and between transects.
...
Copies of the Simrad EK80 \*.raw data files and LSSS workfiles are to be stored on a removable hard drive for processing with Echoview.
...
The pulse duration of all EK80 echosounders is to be standardized at 1ms throughout the survey at maximum ping rate.

The acoustic nautical areas scattering coefficient (NASC) at 38 kHz integrated across the water column for the target species is to be estimated on board using both Echoview and the LSSS.
...
The **Simrad SU90 fisheries sonar** will be operated continuously along and between transects to record acoustic data continuously during the survey.
