...
Target species include sardine ("Pilchard"), anchovy, round herring ("Redeye"), horse mackerel, lanternfish and lightfish with aim to produce abundance estimates.
...
At all trawl hauls, the catch is sorted according to species, and number and weight measurements will be taken for all species.
For priority species length and weight are recorded using an electronic fish meter connected to a standard data acquisition system used on board the vessel (Fish2Data and Biotic Editor) connected on the server of the vessel.
...
Acoustic data post-processing in LSSS is to be done daily during the survey.
