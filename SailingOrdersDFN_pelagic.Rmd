...
ft_surveyplan <- line_spacing(ft_surveyplan, space = 1.5, part = "all")
# Add caption
...
ft_sciencethemestab <- line_spacing(ft_sciencethemestab, space = 1.5, part = "all")
# Add caption
...
Acoustic data is to be logged to a depth of 250m when the water depth is less than 250m and to a depth of 500m when the depth exceeds 250m.
...
Fish team members should alternate with regard to ichthyoplankton sampling duties; all fish team members are to do a ichthyoplankton sampling watch, and one member of the fish team is to be designated this responsibility at all times.
...
# ft_biosamplingtab <- line_spacing(ft_biosamplingtab, space = 1.5, part = "all")
# Add caption
...
***THIS SECTION NEEDS UPDATING*** ######################## Priority pelagic species for biomass estimation by acoustics and targeted trawl sampling: *Sardinella aurita* and *Sardinella maderensis* combined as *Sardinella* spp., *Trachurus* spp., Pelagic Group I, and Pelagic Group II.

Acoustic data post-processing in LSSS is done daily while on survey.
Various acoustic categories will be used to split and assign acoustic backscatter: other, plankton, Sardinella spp., Pelagic Group I and Pelagic Group II (see Annex ?? for detailed fish species list) ######################\# Allocation of acoustic densities to species groups will be done according to Table \@ref(tab:acousticcattab).
...
# ft_acousticcattab <- line_spacing(ft_acousticcattab, space = 1.5, part = "all")
...
# ft_reqparttab <- line_spacing(ft_reqparttab, space = 1.5, part = "all")
# Add caption
...
ft_matstagetab <- line_spacing(ft_matstagetab, space = 1.5, part = "all")
# Add caption
...
#%>% ftExtra::colformat_md()
# ft_fatstageanchtab <- line_spacing(ft_fatstageanchtab, space = 1.5, part = "all")
# Add caption
...
#%>% ftExtra::colformat_md()
# ft_fatstagesarhtab <- line_spacing(ft_fatstagesarhtab, space = 1.5, part = "all")
# Add caption
...
ft_equipmenttab <- line_spacing(ft_equipmenttab, space = 1.5, part = "all")
...
#%>% ftExtra::colformat_md()
ft_datahandovertab <- line_spacing(ft_datahandovertab, space = 1.5, part = "all")
# Add caption
...
ft_collectedsamplestab <- flextable::height(ft_collectedsamplestab,  height = 1.50, unit = "cm")
...
ft_collectedsamplestab <- line_spacing(ft_collectedsamplestab, space = 1.5, part = "all")
...
#%>% ftExtra::colformat_md()
ft_transectpostab <- line_spacing(ft_transectpostab, space = 1.5, part = "all")
# Add caption
...
ft_transectranktab <- line_spacing(ft_transectranktab, space = 1.5, part = "all")
# Add caption
