...
The main objective of this regional survey effort in the NWA (Senegal, The Gambia, Mauritania and Morocco) area, is to assess the abundance and distribution of the transboundary pelagic resources.
...
-   **Acoustic sampling**:
    ...
    -   Estimation of the biomass and population size structure of sardinella, horse mackerel, sardine, anchovy, and mackerel (*S.colias*) by means of echo-integration and trawling.
        In addition, total biomass estimates of Pelagic Group I and II will be provided.

    -   Mapping the spatial distribution of commercially harvested pelagic fish.

-   **Fish biological sampling**:

    -   Composition of the catch (**all taxa** caught in the trawl)

    -   Total catch weight and numbers of all **taxa** caught in each trawl haul, with subsampling where appropriate. 

    -   Collection of biological samples and parameters for priority fish species (see section "**Biological sampling of fisheries resources"**).
...
-   **Other trawl-related sampling**:
    ...
    -   Collection of jellyfish for taxonomic purposes.
