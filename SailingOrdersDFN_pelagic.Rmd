...
Acoustic data post-processing in LSSS and Echoview is to be done daily during the survey. Allocation of acoustic densities to species groups will be done according to Table \@ref(tab:acousticcattab) for the relevant to the survey acoustic groups only.
