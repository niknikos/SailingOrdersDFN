...
The survey will start and end in Dakar, Senegal (Table \@ref(tab:surveyplantab)).
...
The overall objectives of this regional survey effort in the NWA (Gambia, Senegal, Mauritania, Morroco) area are to assess the abundance and distribution of the transboundary pelagic resources. 

A transboundary pelagic survey off Northwest Africa took place in 2019. The survey in 2022 will have the same scope and objectives as in 2019, covering the pelagic resources of Senegal, The Gambia, Mauritania and Morocco. The survey will take place from 6 October 2022 to 16 December 2022 in three sub-legs, starting off from Dakar and ending in Las Palmas. As such, the survey timing coincides with the time when most of the pelagic surveys with the R/V Dr. Fridtjof Nansen have been conducted in this region and will therefore add to the time series of pelagic fish biomass estimates.

The overall objectives identified when planning the pelagic surveys for the current phase of the Programme were to sample the pelagic realm in relation to hydrography (chemical and physical oceanographic conditions), lower trophic levels (phyto-, zoo- and ichthyoplankton and jellyfish), main pelagic stocks (abundance, distribution, biology, food safety/nutrition) and pollution (marine debris, floating seaweed aggregations).


## **Survey area**

The survey area for Leg 5 covers the northwest African continental shelf area:
Leg 5.1 will cover the pelagic fish resources of The Gambia and Senegal.
Leg 5.2 will cover ..
Leg 5.3 will continue ..

The area to be surveyed by the R/V *Dr. Fridtjof Nansen* in Leg 5.1, along with the planned acoustic transects, is shown in Figure \@ref(fig:surveyareamap).
Based on past knowledge about the resources, the coverage will be largely limited inside of the 200m isobath. Because the vessel requires at least 20m bottom depth, transects do not cover shallower areas. This excludes large areas in southern Senegal and The Gambia that contain suitable habitat for pelagic species such as Sardinellas.
...
An overview of the main types of expertise and number of participants required for Leg 5.1 is provided in [ANNEX I](#ANNEX_I) and the list of the planned survey participants for Leg 5.1 is shown in [ANNEX II](#ANNEX_II).
...
The specific objectives of the Leg 5.1 survey are listed below; emphasis will be placed on local needs and scientific importance.
...
-   **Acoustic sampling**:
    ...
    -   Estimation of the biomass and population size structure of sardinella, horse mackerel, sardine, anchovy, and mackerel (*S.colias*) off Senegal and The Gambia by means of echo-integration and trawling. In addition, total biomass of Pelagic Group I and II will be estimated.

    -   Mapping spatial distribution of commercially harvested pelagic fish.

-   **Fish biological sampling**:

    -   Species composition and diversity of the pelagic and demersal communities (all species caught in the pelagic and demersal trawls)

    -   Total catch weight and numbers of all fish species caught in each trawl haul.

    -   Length-weight relationships for priority fish and jellyfish species caught in the trawl.
        A representative catch subsample at each trawl station is taken and a minimum of 100 individuals (or 50 jellyfish) are measured, more as needed to achieve representative length distributions.

    -   Collection of biological data (wet body weight, sex, gonad maturity stage and fat stage) for sardinella, horse mackerel, sardine and anchovy.

    -   Collection of otoliths from sardinella for age determination studies.

    -   Collection of sardine (juveniles and adults) for an analysis of infection by "tetracotyle" type digenean parasite.

    -   Collection of horse mackerel samples for genetics, otoliths and parasites for stock identification purposes.

-   **Other trawl-related sampling**:

    -   Map occurrence, abundance and biological parameters (length, weight, sex, and maturity staging for males) of cartilaginous fish.

    -   Collection of jellyfish (*Chrysaora* spp. and *Aequorea* spp.) tissue for taxonomic purposes.


-   **Ichthyoplankton sampling**:

    -   Collection of ichthyoplankton samples (with custom-CUFES and only underway) during part B of the survey and from Line 61 to Line 80 only for mapping of sardine and round herring (and, if present anchovy) egg distributions.
...
Acoustic data at all available frequencies (18, 38, 70, 120, 200 and 333 kHz) from the Simrad EK80 echo sounder operating in **CW (narrow band)** mode is to be collected continuously while the ship is steaming along and between transects.

Acoustic data is to be logged to 500 m depth, with range adjusted according to bottom depth in shallow waters.
This requires that the acoustic operators remain vigilant of the water depth and adjust the maximum depth logged by the EK80 as appropriate.
...
The Captain/navigating officer on watch must inform the acoustic watch keeper when the vessel crosses a boundary line between strata (see Fig. \@ref(fig:surveyareamap)) so that the ship's log and the time can be recorded for later use in data processing.
Start/end of acoustic transects are registered by the officer on watch in the Survey Logger system.
...
This is the only active sonar to be used on this survey.
...
**The EK80 echosounder, SU90 multibeam sonar and ADCPs must run synchronized with each other via k-sync to ensure no interference from the SU90 and ADCPs on the recorded EK80 data.**
...
No hydrographic sampling in the water column is foreseen to take place during the survey.
...
Fish team members should alternate with regard to ichthyoplankton sampling duties; all fish team members are to do a sampling watch for ichthyoplankton, and one member of the fish team is to be designated this responsibility at all times.
...
13. **Jellyfish sampling for TS-studies and species identification**.

    a.  [TS-studies]{.ul}

    Umbrella diameter (to the nearest 1 cm) and sample mass (kg to 3 decimal places) of a random sample of at least 50 individuals of *Chrysaora fulgida* and central disk diameter (to the nearest 0.5 cm) and sample mass (kg to 3 decimal places) of a random sample of at least 50 individuals of *Aequorea aequorea*.

    b.  [Species identification]{.ul}

    Specimens of large jellyfish that may be caught in the trawl that are in good condition should be fixed in 4% formalin, **AFTER** a piece of tissue from the oral arms has been removed and fixed in 96% ethanol with the jar labelled (internally using a **2B** pencil and externally using a marker -- note that ethanol will remove external markings so care should be taken to keep labels legible) with the species, date, grid and station number and "**JELLYFISH -- M GIBBONS**".
...
14. **Collection of *T. capensis* samples for stock identification purposes.** 

    A sample of 30 *T. capensis* individuals to be collected per latitude degree in the **29-36^o^S region**.
    The following biological sampling is to be carried out:

    -   Each fish will be individually measured for length and weight and information will be registered into the Fish2Data system.

    -   A fin-clip sample for genetic analysis is to be taken from the pectoral fin following the procedure for [genetic analysis](https://nansen-surveys.imr.no/lib/exe/fetch.php?media=nansen-surveys:fishlab_biological_samp_genetics.pdf) described in the Nansen wiki.

    -   Otolith extraction for each fish to be carried out following the protocol for [otoliths](https://nansen-surveys.imr.no/lib/exe/fetch.php?media=nansen-surveys:fishlab_biological_samp_otoliths.pdf) described in the Nansen wiki.

    -   Each fish to be stored individually in a zip-lock plastic bag that includes a waterproof paper label with information on survey, station, species and sample #ID (sequence number) in zip-lock bags.
        All fish from a station to be placed in a common plastic bag with information on survey, station and species included on a waterproof paper label.

    A sample of 30 *T. capensis* individuals to be collected per longitude degree in the **20-27^o^E region**.
    The same procedure as in #14 above is to be followed.
    In the event of bimodal length distribution (juveniles/adults) in this area, 2 sets of samples to be collected per longitude degree, i.e., 1x30 juveniles plus 1x30 adults.
...
Unidentified fish and macroinvertebrates taxa to be preserved according to standard protocols.
