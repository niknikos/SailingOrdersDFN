...
The survey area for Leg 5 covers the northwest African continental shelf area, split into three surveys: The Gambia and Senegal (Leg 5.1), Mauritania (Leg 5.2) and Morocco (Leg 5.3).
...
Based on past knowledge about the resources, the coverage will be largely limited inside of the 500m isobath. Because the vessel requires at least 20m bottom depth, transects do not cover shallower areas. This excludes large areas in southern Senegal and The Gambia that contain suitable habitat for pelagic species such as Sardinellas.
...
An overview of the main types of expertise and number of participants required for the surveys on Leg 5 is provided in [ANNEX I](#ANNEX_I) and the list of the planned survey participants is shown in [ANNEX II](#ANNEX_II).
...
The specific objectives of the Leg 5 surveys are listed below; emphasis will be placed on local needs and scientific importance.
...
Transects will be surveyed northwards in ascending order of transect number (Fig. \@ref(fig:surveyareamap)).

The ship will sample the entire shelf from Senegal's border to Guinnea-Bissau in the south to the border with Mauritania on Leg 5.1 including The Gambia, all of Mauritania and from Cap Blanc to Cap Boujadour on Leg 5.2, and from Cap Boujadour to Tanger on Leg 5.3. Crew changes will take place in Dakar on October 18 and November 15, and the vessel will return to Las Palmas after completing Leg 5 on December 19.
...
Parallel transect with R/V from Senegal, Mauritania and Morocco, respectively, will be conducted on each of the surveys. Calibration of echosounders will take place in Senegal at the beginning of Leg 5.
...
Target species include sardinella (S. aurita and maderensis), horse mackerel, sardine ("Pilchard"), anchovy, mackerel (S. colias), as well as the species groups of clupeids ("PEL1") and other pelagic species (PEL2). Abundance estimates for all the target species/groups will bep produced.
Scrutinization of acoustic data, i.e., splitting total backscatter into target/mix groups and non-targets such as plankton will be carried out twice daily.
...
[**No fish or any other organisms are to be taken from the deck or from the trawl without the expressed permission of the fish team leader.**]{.ul}
...
6.  **Collection of sardine, anchovy and horse mackerel for assessment of their anthropogenic pollutant (herbicides, pharmaceuticals, etc) levels**.

Samples of 3 fish (of similar size) per species are to be taken from trawls with relevant catches (>100 individuals).
...
7. **Jellyfish sampling for TS-studies and species identification**.
...
All demersal species caught in bottom trawls areas were bottom depth requires the use of bottom trawling (<50m) are to be registered according to standard sampling protocol.
