...
If time restrictions do not allow for complete coverage of the planned acoustic transects, (remaining) transects will be reduced to the sections between 20 and 200 m isobaths, except when a target species is detected at the 200 m isobath. In the latter case, the coverage should be continued until no further occurence can be registered. Because target species mostly aggregate in shallower areas, this will ensure sufficient coverage of the relevant distribution areas. 
...
As most of the pelagic species are likely to be concentrated close inshore, it is imperative that the inshore position of each transect, and the inshore transits between transects, be placed as close inshore as safety permits. If safety issues arise at the inshore end of a transect (e.g. artisanal fishers or unknown bathymetry) the transit should swing to deeper waters and return inshore to the start of the next transect.
...
Acoustic backscatter data (EK80) is to be logged down to 500 m depth, with recording range adjustments according to the bottom depth in shallower waters.
...
This requires as input, the integrated acoustic backscatter (S~A~/NASC) per 10 NM or shorter ESDU for each of the species listed, the species composition from the trawls, the length frequency per species and the length frequency sample mass per species, the transect length and the survey area (per stratum). The survey area will be stratified by region and depth (20-100 m, 100-200 m, 200-300 m, 300-500m).
