...
Based on past knowledge about the resources, the coverage will be largely limited inside of the 500m isobath.
...
The ship will sample the entire shelf from Senegal's border to Guinnea-Bissau in the south to the border with Mauritania on Leg 5.1 including The Gambia, all of Mauritania and from Cap Blanc to Cap Boujadour on Leg 5.2, and from Cap Boujadour to Tanger on Leg 5.3.
...
Parallel transect with R/V from Senegal, Mauritania and Morocco, respectively, will be conducted on each of the surveys.
...
Target species include sardinella (S. aurita and maderensis), horse mackerel, sardine ("Pilchard"), anchovy, mackerel (S. colias), as well as the species groups of clupeids ("PEL1") and other pelagic species (PEL2).
Abundance estimates for all the target species/groups will bep produced.
